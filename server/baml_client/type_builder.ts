...
export default class TypeBuilder {
    ...
    Recommendation: ClassViewer<'Recommendation', "title" | "content" | "context" | "priority">;
    ...
    constructor() {
        ...
        this.Recommendation = this.tb.classViewer("Recommendation", [
          "title","content","context","priority",
        ]);
