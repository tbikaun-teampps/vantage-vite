    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          if (options.onTick) {
          const stream = this.stream.ExtractRecommendations(
          questionWithAnswers,
          __baml_options__
          );
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            return raw.parsed(false) as types.Recommendation[]
            } catch (error) {
            ...
            questionWithAnswers: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.Recommendation[], types.Recommendation[]>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for ExtractRecommendations", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.Recommendation[], types.Recommendation[]>(
                  raw,
                  (a): partial_types.Recommendation[] => a,
                  (a): types.Recommendation[] => a,
                  this.ctxManager.cloneContext(),
                  options.signal,
                  )
                  } catch (error) {
