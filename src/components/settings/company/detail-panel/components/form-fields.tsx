...
interface FormInputProps<TFieldValues extends FieldValues> extends FormFieldProps<TFieldValues> {
  placeholder?: string;
  type?: "text" | "number";
  step?: string;
  disabled?: boolean;
...
interface FormSelectProps<TFieldValues extends FieldValues> extends FormFieldProps<TFieldValues> {
        ...
        render={({ field: latField }) => (
          <Controller
            ...
            render={({ field: lngField }) => {
              const hasLocation = latField.value != null && lngField.value != null;
                    ...
                    <div className="text-center space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground/70 mt-1">
                          Click the map button below to specify {siteName.toLowerCase()} coordinates
                        </p>
                      </div>
                      <button
                        type="button"
