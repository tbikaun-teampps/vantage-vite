...
export function InterviewQuestion({
  ...
  const getBreadcrumbs = () => {
    ...
    const breadcrumbs = [];
    if (currentSection) {
      breadcrumbs.push(currentSection.title);
    }
    if (currentStep && currentStep.title !== currentSection?.title) {
      breadcrumbs.push(currentStep.title);
    }
        ...
        <div className="max-w-7xl mx-auto">
                        ...
                        <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-8">
                          <div className="text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-4">
                              Add detailed comments and evidence to support your assessment
                            </p>
                            <div className="text-xs text-muted-foreground mb-4">
                              Feature includes rich text editing, tagging, and evidence linking
                            </div>
                            <Button
                              disabled
                              variant="outline"
                      ...
                      <TabsContent value="evidence" className="space-y-4">
                        <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-8">
                          <div className="text-center">
                            ...
                            <div className="text-xs text-muted-foreground mb-4">
                              Supported formats: PDF, DOC, DOCX, JPG, PNG, CSV,
                              XLSX (Max 10MB)
                            </div>
                            <Button
                              disabled
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              {/* Context - only show if it exists */}
              {question.context && (
          ...
          {(questionRoles.length > 0 || isLoading) && (
            <div className="space-y-4">
              <div className="space-y-1">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (allSelected) {
                          ...
                          form.setValue("role_ids", newRoles, { shouldDirty: true });
                        } else {
                          // Select all roles
                          const newRoles = [...new Set([...currentRoles, ...allRoleIds])];
                          form.setValue("role_ids", newRoles, { shouldDirty: true });
                        }
                      }}
                    >
                ...
                <div className="h-2 flex items-center">
                  {questionRoles.length > 0 &&
                    (!form.watch("role_ids") || form.watch("role_ids").length === 0) && (
                          ...
                          {(() => {
                            ...
                            return Object.entries(groupedRoles).map(
                              ([orgChartName, orgRoles]) => (
                                <div key={orgChartName} className="space-y-2 w-full">
