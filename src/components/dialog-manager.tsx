...
// Hook for widgets to use dialog manager
...
const DialogManagerProvider: React.FC<DialogManagerProviderProps> = ({ children }) => {
  ...
  return (
    <DialogManagerContext.Provider value={{ openDialog, closeDialog, closeAllDialogs }}>
      {children}
